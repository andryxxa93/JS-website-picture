...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(optionsState);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', optionsState);
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var calcFunction = function calcFunction(e) {
...
var filter = function filter() {
  ...
  var createListenersToBtn = function createListenersToBtn(btnSelector, marksSelector) {
  ...
  var typeFilter = function typeFilter(markType) {
    markAll.forEach(function (elem) {
      elem.style.display = 'none';
      elem.classList.remove('animated', 'fadeIn');
    });
    no.style.display = 'none';
    no.classList.remove('animated', 'fadeIn');
    markType.forEach(function (elem) {
...
var scrolling = function scrolling(upScrolling) {
  var pageup = document.querySelector(upScrolling);
  window.addEventListener('scroll', function () {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('col-sm-3', 'animated', 'fadeInUp', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
